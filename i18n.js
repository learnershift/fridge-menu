...
export const STRINGS = Object.freeze({
  en: Object.freeze({
    ...
    quickIngredientsHeading: "Common ingredients",
    quickIngredientEgg: "Egg",
    quickIngredientKimchi: "Kimchi",
    quickIngredientOnion: "Onion",
    quickIngredientTofu: "Tofu",
    quickIngredientScallion: "Scallion",
    quickIngredientMushrooms: "Mushrooms",
    quickIngredientPotato: "Potato",
    quickIngredientCarrot: "Carrot",
    quickIngredientZucchini: "Zucchini",
    quickIngredientBeanSprouts: "Bean sprouts",
    quickIngredientSpinach: "Spinach",
    quickIngredientTomato: "Tomato",
    quickIngredientRice: "Rice",
    quickIngredientNoodles: "Noodles",
    quickIngredientBread: "Bread",
    quickIngredientHam: "Ham",
    quickIngredientBacon: "Bacon",
    quickIngredientTuna: "Tuna",
    quickIngredientChicken: "Chicken",
    quickIngredientPork: "Pork",
    quickIngredientBeef: "Beef",
    quickIngredientCheese: "Cheese",
    quickIngredientMilk: "Milk",
    quickIngredientFishCake: "Fish cake",
    ...
    privacyRightsCopy: "Because the publisher does not receive or process this on-device data, it does not act as a controller for that data. Privacy questions may be sent to support@nuvopilot.com. The official public policy is available at https://nuvopilot.com/apps/fridge-menu/privacy/. People in the EEA may also lodge a complaint with their local data-protection authority, and people in Korea may contact the privacy officer identified in the public policy.",
    ...
    mealMeta: "About {minutes} min · {difficulty}",
    "difficulty.easy": "Easy",
    "difficulty.normal": "Normal",
    otherMenus: "See 3 other menus",
    firstMenus: "Back to first menus",
  ...
  ko: Object.freeze({
    ...
    addIngredient: "재료 추가",
    quickIngredientsHeading: "자주 쓰는 재료",
    quickIngredientEgg: "계란",
    quickIngredientKimchi: "김치",
    quickIngredientOnion: "양파",
    quickIngredientTofu: "두부",
    quickIngredientScallion: "대파",
    quickIngredientMushrooms: "버섯",
    quickIngredientPotato: "감자",
    quickIngredientCarrot: "당근",
    quickIngredientZucchini: "애호박",
    quickIngredientBeanSprouts: "콩나물",
    quickIngredientSpinach: "시금치",
    quickIngredientTomato: "토마토",
    quickIngredientRice: "밥",
    quickIngredientNoodles: "면",
    quickIngredientBread: "식빵",
    quickIngredientHam: "햄",
    quickIngredientBacon: "베이컨",
    quickIngredientTuna: "참치",
    quickIngredientChicken: "닭고기",
    quickIngredientPork: "돼지고기",
    quickIngredientBeef: "소고기",
    quickIngredientCheese: "치즈",
    quickIngredientMilk: "우유",
    quickIngredientFishCake: "어묵",
    ...
    privacyRightsCopy: "개발자는 기기 안에만 있는 이 데이터를 받거나 처리하지 않으므로 해당 데이터의 컨트롤러가 아니에요. 개인정보 문의는 support@nuvopilot.com으로 보낼 수 있어요. 공식 공개 처리방침은 https://nuvopilot.com/apps/fridge-menu/privacy/에서 확인할 수 있어요. EEA 거주자는 현지 감독기구에, 한국 이용자는 공개 처리방침에 안내된 개인정보 보호책임자에게 문의할 수 있어요.",
    ...
    mealMeta: "약 {minutes}분 · {difficulty}",
    "difficulty.easy": "쉬움",
    "difficulty.normal": "보통",
    otherMenus: "다른 메뉴 3가지 보기",
    firstMenus: "처음 메뉴로",
